...
import { Bell, Leaf, Wallet, ClipboardCheck, ShieldCheck, Megaphone } from 'lucide-react'

const MOCK_NOTIFICATIONS = [
  { id: 1, title: 'Leave Approved', message: 'Your leave request for June 28-30 has been approved.', status: 'unread', created_at: new Date().toISOString(), type: 'leave' },
  { id: 2, title: 'Payroll Generated', message: 'Your payslip for June 2024 is ready to view.', status: 'read', created_at: new Date(Date.now() - 3600000).toISOString(), type: 'payroll' },
  { id: 3, title: 'Attendance Reminder', message: "You haven't marked today's attendance yet.", status: 'unread', created_at: new Date(Date.now() - 7200000).toISOString(), type: 'attendance' },
  { id: 4, title: 'Role Updated', message: 'Your role has been updated to Manager.', status: 'read', created_at: new Date(Date.now() - 86400000).toISOString(), type: 'roles' },
]
